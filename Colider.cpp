...
void Colider::SetRectColider(int xleft, int ytop, int xright, int ybottom)
{
	vertexInfo.clear();
	vertexInfo.push_back({ xleft,ytop });
	vertexInfo.push_back({ xright,ytop });
	vertexInfo.push_back({ xright,ybottom });
	vertexInfo.push_back({ xleft , ybottom });
}